...
"%ProgramFiles%\Microsoft Visual Studio 10.0\Common7\IDE\mstest.exe" /testcontainer:MarieCurieTests\bin\debug\MarieCurieTests.dll /category:"wip" /resultsfile:TestResults.trx 
